...
Read the full paper [here](https://github.com/cstiano/actor-critic-parameterized-actions-rcss2d/paper/Actor_Critic_Architectures_in_Parameterized_Action_Space_for_RoboCup_Soccer_Simulator_2D.pdf).
