...
if EXPERIMENT == 1:
    ...
    ddpg_df = pd.read_csv("/Users/cristianooliveira/personal-development/tcc/tg-repo/results/csv/run_2020-09-28_19-28-01_DDPG_BALL_TO_GOAL_A7_R3_S3-tag-Rewards_epi_reward.csv")
    del sac_df["Wall time"]
    del td3_df["Wall time"]
    del ddpg_df["Wall time"]

    sac_df = sac_df.drop(sac_df[sac_df["Step"] > 12000].index)
    td3_df = td3_df.drop(td3_df[td3_df["Step"] > 12000].index)
    ddpg_df = ddpg_df.drop(ddpg_df[ddpg_df["Step"] > 12000].index)
